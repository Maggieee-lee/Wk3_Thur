...
```{r}
world_vaccination <- read.csv(here("data", "world_vaccination.csv"))
world_vaccination <- filter(world_vaccination, pct_vaccinated != "NA" & who_region != "(WHO) Global")
```
...
```{r}
# Your code below:
filter(world_vaccination, !is.na(pct_vaccinated) & !is.na(who_region))
```
...
world_vacc_plot <- world_vaccination %>%
  ...
  geom_point() +
  labs (x = "year", y = "percentage of people vaccinated", fill ="who_region") + 
  ggtitle("people vaccinated by year")
...
polio_regions_line <- polio %>%
  ggplot(aes(x = yr, y = pct_vaccinated, colour = who_region)) +
  geom_line() +
  labs (x = "year", y = "percentage of people vaccinated", color = "WHO Regions") + 
  ggtitle("Polio Regions")
```
...
```{r}
hepB <- filter(world_vaccination, vaccine == "hepatitis_b")

hepB_regions_line <- hepB %>%
  ggplot(aes(x = yr, y = pct_vaccinated, colour = who_region)) +
  geom_line() +
  labs (x = "year", y = "percentage of people vaccinated", color = "WHO Regions") + 
  ggtitle("Hepatitis B Regions")

Vaccine_line <- world_vaccination %>%
  ggplot(aes(x = yr, y = pct_vaccinated, colour = who_region)) +
  geom_line() +
  labs (x = "year", y = "percentage of people vaccinated", color = "WHO Regions") + 
  ggtitle("Vaccines")+
